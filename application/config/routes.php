...
$route['vnsadmin/([a-zA-Z0-9_-]+)/([a-zA-Z0-9_-]+)'] = 'admin/$1/$2';

$route['vnsadmin/([a-zA-Z0-9_-]+)/([a-zA-Z0-9_-]+)/([a-zA-Z0-9_-]+)'] = 'admin/$1/$2/$3';

/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/



$route['vnsadmin'] = 'admin/defaults/index';

$route['vnsadmin/doi-mat-khau'] = 'admin/admin/admin_change_password';

$route['vnsadmin/site_option'] = 'admin/admin/site_option';

$route['vnsadmin/huong-dan-su-dung'] = 'admin/admin/documentation';

//Modules=================================================================

$route['vnsadmin/danh-sach-modules'] = 'admin/modules/list';

$route['vnsadmin/quan-ly-modules'] = 'admin/modules/modulemanager';

$route['vnsadmin/edit-modules/(:num)'] = 'admin/modules/modulemanager/$1';

$route['vnsadmin/delete-module/(:num)'] = 'admin/modules/delete/$1';



//phan quyen admin

$route['vnsadmin/admin-permission'] = 'admin/admin/admin_permission';

$route['vnsadmin/admin-permission-edit/(:num)'] = 'admin/admin/admin_permission/$1';

$route['vnsadmin/admin-reset-pass/(:num)'] = 'admin/admin/reset_pass/$1';

$route['vnsadmin/admin-permission-delete/(:num)'] = 'admin/admin/delete_acc/$1';
...
$route['vnsadmin/menu/savelist'] = 'admin/menu/saveList';
