...
//    ======================================================================================================================
...

    {
        ...
        if($this->input->get()){
            ...
            $config['base_url']             = base_url('vnsadmin/product/products?code='
            ...
            $config['base_url'] = base_url('vnsadmin/product/products');
...

    {
        ...
        if (isset($_POST['addnews'])) {
            ...
            redirect(base_url('vnsadmin/product/products'));
...

    {
...

        {
            ...
            redirect(base_url('vnsadmin/product/images/'.$id));
...
//******* danh muc ********************************************************
...

    {
        ...
        if (isset($_POST['addnews'])) {
            ...
            redirect(base_url('vnsadmin/product/categories'));
