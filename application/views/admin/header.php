...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a  href="<?= base_url('')?>vnsadmin" class="logo">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <a href="<?= base_url('vnsadmin')?>" class="sidebar-toggle" data-toggle="offcanvas" role="button">
      ...
      <div class="navbar-custom-menu">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown tasks-menu">
            ...
            <a href="<?= base_url('vnsadmin/news/newslist')?>" class="dropdown-toggle" data-toggle="dropdown">
          ...
          <li class="dropdown messages-menu">
            ...
            <a href="<?= base_url('vnsadmin/email/emails')?>" class="dropdown-toggle">
          ...
          <li class=" messages-menu">
            ...
            <a href="<?= base_url('vnsadmin/users/listusers')?>" class="dropdown-toggle">
          ...
          <li class=" messages-menu">
            ...
            <a href="<?= base_url('vnsadmin/order/orders')?>" class="dropdown-toggle">
          ...
          <li class="dropdown notifications-menu">
            ...
            <a href="<?= base_url('vnsadmin/contact/contacts')?>" class="dropdown-toggle" >
          ...
          <li class="dropdown tasks-menu">
            ...
            <a href="<?= base_url('vnsadmin/product/products')?>" class="dropdown-toggle" data-toggle="dropdown">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="col-lg-5">
                  ...
                  <a href="<?= base_url('vnsadmin/users')?>" class="btn btn-default btn-flat">Tài khoản</a>

                </div>

				 <div class="col-lg-7">

                  <a href="<?= base_url('vnsadmin/doi-mat-khau')?>" class="btn btn-default btn-flat">Thay đổi mật khẩu</a>
            ...
            <a href="<?= base_url('vnsadmin/logout/index')?>" class="dropdown-toggle" >
          ...
          <li class="dropdown">
			...
			<ul class="dropdown-menu">
				...
				<li>
					...
					<a href="<?= base_url('vnsadmin/users/listuser_admin')?>"><i class="fa fa-fw fa-users"></i>
				...
				<li>
					...
					<a href="<?= base_url('vnsadmin/group/listGroup')?>"><i class="fa fa-fw fa-refresh"></i> Quản lý  module</a>

				</li>

        <li>

          <a href="<?= base_url('vnsadmin/admin/listDoc')?>"><i class="fa fa-fw fa-refresh"></i> Quản lý hướng dẫn</a>
...
<?php if($this->session->userdata('phanquyen')) {
    ...
    <li><a href="<?= base_url('vnsadmin/admin/documentation')?>"><i class="fa fa-book"></i> <span>Hướng dẫn quản trị</span></a></li>
<!-- chi hien thị trên may noi bo khi xuat ra se k co -->
		<!-- <li><a href="<?= base_url('vnsadmin/admin/setup_wiget')?>"><i class="fa fa-book"></i> <span>Cấu hình wiget</span></a></li> -->
<!-- DONG KHOI -->
