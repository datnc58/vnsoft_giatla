...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('vnsadmin/news/categories')?>">Danh sách danh mục tin</a></li>
...
<section class="content">
    ...
    <div class="box">
        <div class="box-header">
            <a href="<?= base_url('vnsadmin/news/addnews')?>" class="btn btn-success btn-sm">
        ...
        <!-- /.box-header -->
        <div class="box-body">
			<form name="formbk" method="post" action="<?=base_url('vnsadmin/news/deletes')?>">
                <table id="example" class="table table-bordered table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="<?= base_url('vnsadmin/news/edit/' . $v->id) ?>"><?= @$v->title ?></a></td>
							...
							<td class="text-center">
								...
								<a class="btn btn-xs btn-default"
								   href="<?= base_url('vnsadmin/news/edit/' . $v->id) ?>"><i
										class="fa fa-pencil"></i> </a>
								<a class="btn btn-xs btn-danger"
								   href="<?= base_url('vnsadmin/news/delete/' . $v->id) ?>" title="Xóa"
