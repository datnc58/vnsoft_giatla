...
<?php if(@$config_home->slogan==1){ ?>
    ...
    <div class="form-group">
        ...
        <label  class="col-sm-12">Tầm nhìn</label>

        <div class="col-sm-12">

            <input name="future" type="text" class="form-control input-sm"

                   value="<?=@$row->future;?>" placeholder="">
...
<?php if(@$config_home->link_fb==1){ ?>
						<div class="form-group">

							<label  class="col-sm-12"><?=@$config_text->link_fb;?></label>

							<div class="col-sm-12">

								<input name="link_fb" type="text" class="form-control input-sm"

									value="<?=@$row->link_fb;?>" placeholder="">
