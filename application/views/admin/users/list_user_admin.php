...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('vnsadmin/users/listuser_admin')?>">Danh sách thành viên quản trị</a></li>
...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-header"> 
            ...
            <a href="<?= base_url('vnsadmin/users/add_users')?>" class=" btn btn-success btn-sm">
        ...
        <div class="box-body">
			...
			<form name="formbk" method="post" action="<?=base_url('vnsadmin/users/deletes')?>">
					...
					<tbody>
						...
						<tr>
							...
							<td class="text-center">
								...
								<a class="btn btn-xs label-success" href="<?= base_url('vnsadmin/admin/permission/1') ?>" title="cap nhat"><i class="fa fa-gears"></i> </a>
						...
						<tr>
							...
							<td class="text-center">
								...
								<a class="btn btn-xs label-success"
								   ...
								   href="<?= base_url('vnsadmin/admin/permission/' . $v->id) ?>" title="Xóa"
								...
								<a class="btn btn-xs btn-danger"
								   ...
								   href="<?= base_url('vnsadmin/users/delete/' . $v->id) ?>" title="Xóa"
