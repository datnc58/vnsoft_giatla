(function (j, f, c, i, d, l, g) {/*! Jssor */
    ...
    var e = j.$JssorEasing$ = {$EaseSwing: function (a) {
    ...
    var b = j.$Jssor$ = new function () {
        ...
        function Ib() {
            if (!L) {
                L = {Rf: "ontouchstart"in j || "createTouch"in f};
                var a;
        ...
        h.Wg = function (d, a) {
            if (a)d.style.clip = "rect(" + c.round(a.$Top || a.D || 0) + "px " + c.round(a.$Right) + "px " + c.round(a.$Bottom) + "px " + c.round(a.$Left || a.C || 0) + "px)"; else if (a !== g) {
        ...
        var W = {$Opacity: h.Bb, $Top: h.B, $Left: h.v, Q: h.$CssWidth, P: h.$CssHeight, Cb: h.s, ci: h.W, $ZIndex: h.G};

        function w(f, l) {
            var e = Q(), b = H(), d = fb(), j = M(f);

            function k(b, d, a) {
                var e = b.rb(p(-d / 2, -a / 2)), f = b.rb(p(d / 2, -a / 2)), g = b.rb(p(d / 2, a / 2)), h = b.rb(p(-d / 2, a / 2));
                b.rb(p(300, 300));
            ...
            function a(d, a) {
                a = a || {};
                var n = a.$TranslateZ || 0, p = (a.$RotateX || 0) % 360, q = (a.$RotateY || 0) % 360, u = (a.$Rotate || 0) % 360, l = a.$ScaleX, m = a.$ScaleY, f = a.bi;
                if (l == g)l = 1;
                if (m == g)m = 1;
                if (f == g)f = 1;
                if (e) {
            ...
            w = function (e, c) {
                ...
                if (c.Xd)if (d)yb(h.$CreateCallback(i, O, e, c)); else a(e, c)
            };
            h.zb = O;
            if (d)h.zb = w;
        ...
        var P = {bd: 0, dd: 0, C: 0, D: 0, $Zoom: 1, $ScaleX: 1, $ScaleY: 1, $Rotate: 0, $RotateX: 0, $RotateY: 0, $TranslateX: 0, $TranslateY: 0, $TranslateZ: 0, $SkewX: 0, $SkewY: 0};
        h.Jc = function (a) {
            var c = a || {};
            if (a)if (b.nd(a))c = {Lc: c}; else if (b.nd(a.$Clip))c.$Clip = {Lc: a.$Clip};
            return c
        };
        function wb(c, a) {
            var b = {};
        ...
        h.jd = function (l, m, x, q, z, A, n) {
            ...
            if (m.$Clip && n.$Move) {
                var o = a.$Clip.gc, s = (o.$Top || 0) + (o.$Bottom || 0), r = (o.$Left || 0) + (o.$Right || 0);
                a.$Left = (a.$Left || 0) + r;
                a.$Top = (a.$Top || 0) + s;
                a.$Clip.$Left -= r;
                a.$Clip.$Right -= r;
    ...
    var m = function (z, C, g, M, P, J) {
        ...
        function K() {
            if (q) {
                var d = b.O(), e = c.min(d - A, g.Yc), a = h + e * p;
                A = d;
                if (a * p >= o * p)a = o;
                u(a);
    ...
    j.$JssorSlideshowRunner$ = function (k, s, q, u, z) {
        ...
        function j(g, f) {
            var a = {$Interval: f, $Duration: 1, $Delay: 0, $Cols: 1, $Rows: 1, $Opacity: 0, $Zoom: 0, $Clip: 0, $Move: l, $SlideOut: l, $Reverse: l, $Formation: p.$FormationRandom, $Assembly: 1032, $ChessMode: {$Column: 0, $Row: 0}, $Easing: e.$EaseSwing, $Round: {}, Nb: [], $During: {}};
            b.o(a, g);
            t(a);
            a.Sb = a.$Cols * a.$Rows;
            ...
            a.ae = function (c, b) {
                ...
                if (!a.Nb[f]) {
                    a.Nb[f] = {Q: c, P: b};
                    for (var d = 0; d < a.$Cols; d++)for (var e = 0; e < a.$Rows; e++)a.Nb[f][e + "," + d] = {$Top: e * b, $Right: d * c + c, $Bottom: e * b + b, $Left: d * c}
                }
                return a.Nb[f]
            };
            if (a.$Brother) {
            ...
            z.Tb = function (d) {
                ...
                if (e || y) {
                    ...
                    b.$Each(j, function (a, e) {
                        ...
                        if (a.wd != d) {
                            if (!a.wd && !k)b.z(n[e]); else d == a.he && k && b.S(n[e]);
                            a.wd = d;
                            b.L(n[e], a[d])
                        }
                    })
    ...
    var k = j.$JssorSlider$ = function (p, hc) {
        ...
        function Dc() {
            ...
            m.call(a, -1, 2, {$Easing: e.$EaseLinear, Oe: {Cb: bc}, Dc: r}, b, {Cb: 1}, {Cb: -2});
            a.Mb = b
        }
        ...
        function Bc(j, f) {
            ...
            function ab(b) {
                if (b == R && s == f) {
                    if (!g) {
                        var a = i;
                        if (A)if (A.ib == f)a = A.lf(); else A.Ib();
                        Y();
                        g = new zc(j, f, a, q);
                        g.Oc(p)
                    }
            ...
            function T(a, c, e) {
                ...
                b.$Each(f, function (f) {
                    ...
                    if (i == "player" && !v) {
                        v = f;
                        if (v.pInstance)Q(); else b.$AddEvent(v, "dataavailable", Q)
                    }
                    if (i == "caption") {
                        if (c) {
                        ...
                        if (h == "A") {
                            if (b.$AttributeEx(f, "u") == "image")o = b.Jf(f, "IMG"); else o = b.$FindChild(f, "image", d);
                            if (o) {
                                w = f;
                                b.W(w, "block");
                                b.L(w, V);
        ...
        b.$Each(yc, function (a) {
            if (a.tagName == "DIV" && !b.$AttributeEx(a, "u"))T.push(a); else b.wb() && b.G(a, (b.G(a) || 0) + 1)
        });
    ...
    j.$JssorThumbnailNavigator$ = function (g, B) {
        ...
        h.mc = function (F, D) {
            if (!w) {
                ...
                var E = b.o({$AutoPlay: l, $NaviQuitDrag: l, $SlideWidth: n, $SlideHeight: j, $SlideSpacing: q * h + r * (1 - h), $MinDragOffsetToSlide: 12, $SlideDuration: 200, $PauseOnHover: 1, $PlayOrientation: a.$Orientation, $DragOrientation: a.$NoDrag || a.$DisableDrag ? 0 : a.$Orientation}, a);
                s = new k(g, E);
                w = d
            }
        };
    ...
    j.$JssorCaptionSlideo$ = function (v, j, u) {
        ...
        function q(d, c) {
            ...
            b.$Each(d, function (d, f) {
                var e = n[f];
                if (e) {
                    if (b.Fd(d))d = q(d, c || f == "e"); else if (c)if (b.ac(d))d = w[d];
                    a[e] = d
                }
            });
            return a
        ...
        function s(e, c) {
            ...
            b.$Each(d, function (d) {
                ...
                if (h) {
                    var e = b.$AttributeEx(d, "t"), g = p[b.Zb(e)] || p[e], f = {$Elmt: d, Ac: g};
                    a.push(f)
                }
        ...
        function z(k, n, e) {
            ...
            b.$Each(n, function (g) {
                ...
                var p = {$Easing: j, $OriginalWidth: e.Q, $OriginalHeight: e.P}, n = new m(g.b, g.d, p, k, e, f), h = t[g.b];
                if (h == i) {
                    h = {N: g.b, ic: []};
                    t[g.b] = h;
                    l(o, h, g.b)
            ...
            if (a && a.Gc.length) {
                var g = new m(a.N, a.jb - a.N, {Dc: a.jb - a.N, Pe: d, Ye: d});
        ...
        function y(a) {
            b.$Each(a, function (f) {
                var a = f.$Elmt, e = b.$CssWidth(a), d = b.$CssHeight(a), c = {$Left: b.v(a), $Top: b.B(a), C: 0, D: 0, $Opacity: 1, $ZIndex: b.G(a) || 0, $Rotate: 0, $RotateX: 0, $RotateY: 0, $ScaleX: 1, $ScaleY: 1, $TranslateX: 0, $TranslateY: 0, $TranslateZ: 0, $SkewX: 0, $SkewY: 0, Q: e, P: d, $Clip: {$Top: 0, $Right: e, $Bottom: d, $Left: 0}};
                c.bd = c.$Left;
                c.dd = c.$Top;
                z(a, f.Ac, c)
            })
        ...
        y(s(v, 1));
        g(e, o);
        var x = j.$Breaks || [], k = [].concat(x[b.Zb(b.$AttributeEx(v, "b"))] || []);
        k.push({b: e.Db(), d: k.length ? 0 : u});
        A(k);
        g(a, f, a.Db());
        a.E(-1)
    }
